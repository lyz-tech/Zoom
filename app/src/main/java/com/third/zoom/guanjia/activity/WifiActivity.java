...
import com.third.zoom.guanjia.adapter.WifiListAdapter;
import com.third.zoom.guanjia.bean.WifiBean;
import com.third.zoom.guanjia.utils.AppContants;
import com.third.zoom.guanjia.utils.CollectionUtils;
import com.third.zoom.guanjia.utils.WifiSupport;
import com.third.zoom.guanjia.widget.WifiLinkDialog;
...
public class WifiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgBack = (ImageView) findViewById(R.id.img_change_back);
        hidingProgressBar();
    ...
    private void initRecycler() {
        ...
        if(WifiSupport.isOpenWifi(WifiActivity.this) && mHasPermission){
            ...
            Toast.makeText(WifiActivity.this,"WIFI处于关闭状态或权限获取失败22222",Toast.LENGTH_SHORT).show();
        }
